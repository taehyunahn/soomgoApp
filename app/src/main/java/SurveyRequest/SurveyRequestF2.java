...
public class SurveyRequestF2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_survey_request_f2, container, false);
        ...
        cb_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                } else if (!cb_1.isChecked() && !cb_2.isChecked() && !cb_3.isChecked() && !cb_4.isChecked() && !cb_5.isChecked()){
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                surveyRequestMainActivity.fragmentChange(3);
            }
        });
    ...
    public void onPause() {
        ...
        String how = result.substring(0, result.length() - 2);


        editor.putString(userSeq+"how", how);
        editor.commit();

        Log.i(TAG, "fragment2에서 저장된 값 = " + sharedPreferences.getString(userSeq + "how", ""));
